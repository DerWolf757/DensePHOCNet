...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_net_name', '-snn', action='store', type=str, default = None,
                      help='Name of the saved network model')
    ...
    # Architecture
    parser.add_argument('--architecture', '-arch', action='store', type=str, default='phoc',
                        help='The general architecture (phoc, dense, hybrid,')
