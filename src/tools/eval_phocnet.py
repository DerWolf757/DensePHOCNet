...
if __name__ == '__main__':
    ...
    standard_args.add_argument('--doc_img_dir', action='store', type=str,
    ...
    standard_args.add_argument('--train_xml_file', action='store', type=str,
                               help='The READ-style XML file of words used in training')
    standard_args.add_argument('--test_xml_file', action='store', type=str,
    ...
    standard_args.add_argument('--dense_net', '-dn', action='store', type=str,
                               help='Dense Net protofile')
    
    standard_args.add_argument('--min_image_width', '-min_w', action='store', type=int, default = 30,
                               help='Minimal image width in lmdb.')
    standard_args.add_argument('--min_image_height', '-min_h', action='store', type=int, default = 30,
                               help='Minimal image height in lmdb.')
    standard_args.add_argument('--max_pixel', '-max_p', action='store', type=int, default = 50000,
                               help='maximum image height in lmdb.')
    standard_args.add_argument('--image_size', '-img_size', action='store', nargs='+', type=int,
                               help='The size of the images')
    
    # --- protocol
    standard_args.add_argument('--protocol', '-p', action='store', type=str, default='almazan',
                               help='The evaluation protocol')
