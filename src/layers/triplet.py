...
class TripletLayer(caffe.Layer):
    ...
    def reshape(self, bottom, top):
        top[0].reshape(1,1,50,150)
        top[1].reshape(1,1,50,150)
        top[2].reshape(1,1,50,150)
    ...
    def forward(self, bottom, top):
        ...
        top[0].reshape(1,data0.shape[0],data0.shape[1],data0.shape[2])
        top[0].data[...] = data0
        ...
        top[1].reshape(1,data1.shape[0],data1.shape[1],data1.shape[2])
        top[1].data[...] = data1
        ...
        top[2].reshape(1,data2.shape[0],data2.shape[1],data2.shape[2])
        top[2].data[...] = data2 
